...
but there is no supported native Linux build. The engine runs in the UTF-8
code page, which needs Windows 10 version 1903 or newer; on older Windows the
game text still shows, but a path or file name with accented characters may
fail.
