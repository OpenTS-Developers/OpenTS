...
// Where a picture of the given size lands inside a box, kept in proportion and centered.
...
// pixel short of the frame and the gap all on one side; this centers it instead. False,
...
// them: each pixel takes the one under its middle, which is where GDI's COLORONCOLOR
