...
A screen opens as the original dialogs did, sliding out from the middle behind the side bars with the dialog sound, and a document can turn that off for itself. The options menu is the first screen rebuilt on the kit, so it looks like the original again rather than like the plain layout it had.
