...
The three numbers are separated by commas; a value that is not three numbers keeps the default, black. The color is used only with [`TargetLineDropShadow=yes`](/keys/targetlinedropshadow/).
