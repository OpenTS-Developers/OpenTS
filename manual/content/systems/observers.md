...
| --- | --- |
| Shroud and fog | Every cell is revealed and unfogged, the fogged copies of structures are discarded, and neither [regrowth pass](/systems/map-visibility/#losing-ground-again) runs again |
...
Any number of people may watch as long as somebody plays, a computer included; a launch file in which everyone watches and no computer plays is refused. One person playing beside observers is accepted; with no opponent, that match ends when the player is defeated. An observer who leaves is announced like any other player, and nothing is handed to the computer.
